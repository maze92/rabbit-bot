...
const API_BASE = '/api';
  ...
  // Deterministic loading control used by feature modules.
...
// Logs controls
  ...
  window.OzarkDashboard.getGuildId = function () { return state.guildId; };
