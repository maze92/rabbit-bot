...
app_subtitle: 'Dashboard de moderação e gestão',
      ...
      extras_trust_edit_hint: 'A configuração detalhada continua disponível na tab Configuração. Estes campos ainda são apenas de pré-visualização; em breve poderão ser guardados pela dashboard.',
        extras_title: 'Extras',
        extras_hint: 'Ferramentas adicionais: feeds de notícias e voz temporária.',
        extras_feeds_tab: 'Feeds',
        extras_tempvoice_tab: 'Voz temporária',
...
cases_error_generic: 'Não foi possível carregar os casos.',
      ...
      config_dashboard_users_add_button: 'Adicionar utilizador',
