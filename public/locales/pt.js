...
'config_logs_section_title': "📜 Registos e canais de logs",
  ...
  'extras_trust_hint': 'Cada utilizador tem um score de confiança entre 0 e 100. Penalizações (WARN, MUTE, etc.) fazem o score descer; bom comportamento, sem infrações, faz o score recuperar ao longo do tempo.',
  'extras_trust_levels_body': 'Os níveis de confiança agrupam utilizadores em faixas de risco (baixo, médio, alto). Quanto mais infrações um utilizador acumula e quanto mais graves forem, mais rápido o score desce e mais cedo atinge níveis de risco elevados.',
  ...
  'logs_server_insights_warns': 'Avisos',
  'logs_server_insights_mutes': 'Mutes',
  'logs_server_insights_bans': 'Bans',
