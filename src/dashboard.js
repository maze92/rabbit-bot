...
function isAuthEnabled() {
  ...
  // Se não houver token definido ou se o requireAuth estiver a false,
  // não aplicamos autenticação no dashboard.
  if (!shouldRequire || !token) {
...
function requireDashboardAuth(req, res, next) {
  // Se a autenticação não estiver ativa (sem token ou requireAuth=false),
