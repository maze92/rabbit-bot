...
try {
  ...
  console.warn('[Dashboard] FreeToKeepPost model not loaded (did you create src/database/models/FreeToKeepPost.js?)');
}
...
// FreeToKeep (Epic/Steam/Ubisoft) dashboard endpoints
