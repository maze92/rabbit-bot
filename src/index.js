...
async function ensureMongoIndexes() {
  try {
    ...
    const GiveawayPost = safeRequire('./database/models/GiveawayPost');

    [Ticket, TicketCounter, TicketLog, Infraction, DashboardLog, DashboardAudit, User, UserActivity, PresenceSession, GameNewsFeed, GameNews, GiveawayPost]
      .filter(Boolean)
